...
public class IndexValuesTest extends EstatioIntegrationTest {
    ...
    public static class FindIndexValueByIndexAndStartDate extends IndexValuesTest {
        ...
        public void happyCase() throws Exception {
            ...
            // when, then
            assertThat(indexValueRepository.findIndexValueByIndexAndStartDate(index, VT.ld(2013, 1, 1)).getValue(), is(VT.bd("106.7000")));
            assertThat(indexValueRepository.findIndexValueByIndexAndStartDate(index, VT.ld(2013, 10, 1)).getValue(), is(VT.bd("107.1000")));
        }
