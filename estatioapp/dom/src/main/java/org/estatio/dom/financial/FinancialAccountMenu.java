...
@DomainServiceLayout(
        ...
        menuOrder = "30.1")
public class FinancialAccountMenu extends UdoDomainRepositoryAndFactory<FinancialAccount> {

    public FinancialAccountMenu() {
        super(FinancialAccountMenu.class, FinancialAccount.class);
    }
