...
@DomainServiceLayout(
        ...
        menuOrder = "80.4")
public class CurrencyMenu extends UdoDomainRepositoryAndFactory<Currency> {

    public CurrencyMenu() {
        super(CurrencyMenu.class, Currency.class);
    }
    ...
    public List<Currency> newCurrency(
        ...
        return currencyRepository.newCurrency(reference, name);
    }
